    ...
    return (
        <>
            <div className="container p-10 mx-auto">
                <Carousel>
                <h1 className="text-3xl font-medium title-font pb-5 text-center">What our Client Say</h1>
                    <CarouselContent>
                        <CarouselItem>
                                    ...
                                    <div className="flex flex-wrap -m-4">
                                        <div className="p-4 md:w-1/2 w-full">
                                            <div className="h-full bg-gray-100 p-8 rounded">
                                                ...
                                                <a className="inline-flex items-center">
                                                    <img alt="testimonial" src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                                                    <span className="flex-grow flex flex-col pl-4">
                                                        <span className="title-font font-medium text-gray-900">Jon doe</span>
                                                        <span className="text-gray-500 text-sm flex gap-2 py-1"><MapPin size={20}/>United Kingdum</span>
                                                    </span>
                                                </a>
                                            </div>
                                        </div>
                                        <div className="p-4 md:w-1/2 w-full">
                                            <div className="h-full bg-gray-100 p-8 rounded">
                                                ...
                                                <a className="inline-flex items-center">
                                                    <img alt="testimonial" src="https://img.freepik.com/free-photo/young-beautiful-woman-pink-warm-sweater-natural-look-smiling-portrait-isolated-long-hair_285396-896.jpg" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                                                    <span className="flex-grow flex flex-col pl-4">
                                                        <span className="title-font font-medium text-gray-900">Jon doe</span>
                                                        <span className="text-gray-500 text-sm flex gap-2 py-1"><MapPin size={20}/>United Kingdum</span>
                                                    </span>
